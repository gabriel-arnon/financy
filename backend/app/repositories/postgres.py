...
from app.repositories.postgres_accounts_cards import PostgresAccountsCardsMixin
from app.repositories.postgres_categories_rules import PostgresCategoriesRulesMixin
from app.repositories.postgres_jobs import PostgresJobsMixin
from app.repositories.postgres_payees import PostgresPayeesMixin
...
class PostgresRepository(PostgresCategoriesRulesMixin, PostgresAccountsCardsMixin, PostgresPayeesMixin, PostgresJobsMixin):
